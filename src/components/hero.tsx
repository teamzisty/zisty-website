...
export default function Hero() {
    return (
        <section className="relative w-full h-screen py-45 overflow-hidden bg-black">
            ...
            <div className="relative container px-4 mx-auto text-center">
                <div className="max-w-3xl mx-auto space-y-6">
                    ...
                    <div className="flex justify-center items-center mt-25 gap-160">
                        <div className="relative w-[200px] h-[500px]">
                            ...
                            <div className="absolute top-[180px] right-4">
                                <MultiCursor cursors={[{ id: 5, name: "Webfullsympathy", color: "8, 145, 178 ", side: "left" }]} />
                            </div>
                            <div className="absolute top-[260px] right-[10px]">
                                <MultiCursor cursors={[{ id: 7, name: "doracord", color: "147, 51, 234 ", side: "left" }]} />
                            </div>
